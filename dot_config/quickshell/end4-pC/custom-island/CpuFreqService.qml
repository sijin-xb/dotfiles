// ─────────────────────────────────────────────────────────────────────────────
// 从 Brain_Shell 移植：src/services/system/CpuFreqService.qml
// 改动：无（只有标准 import），正文逐字保留。
// 说明：本机用 amd-pstate，scaling_governor / scaling_cur_freq 都可读，
//       所以 governor / curFreqStr 是真实数据；auto-cpufreq 未安装，
//       daemonActive 会如实为 false（不是 bug）。
// ─────────────────────────────────────────────────────────────────────────────
