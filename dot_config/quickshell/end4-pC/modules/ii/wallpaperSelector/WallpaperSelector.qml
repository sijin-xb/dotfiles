...
Scope {
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            // 开合动画：自下方滑入 + 淡入，退场反向滑下 + 淡出。
            // 不用 scale，让位移方向明确是「从下面上来」。
            WallpaperSelectorContent {
                ...
                // 相对最终位置向下偏移的像素。面板贴底，起点比终点低这么多。
                readonly property real slideOffset: 36
