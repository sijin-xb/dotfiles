...
Scope {
    ...
    PanelWindow {
        ...
        // Exclusive: a HyprlandFocusGrab over this window would break the
        // input-method bridge, making Chinese input impossible in text fields
        WlrLayershell.keyboardFocus: GlobalStates.settingsOpen ? WlrKeyboardFocus.Exclusive : WlrKeyboardFocus.None
        color: "transparent"
