    ...
    ColumnLayout {
        ...
        ContentSection {
            ...
            GroupedList {
                ...
                // 浏览器把网页视频也通过 MPRIS 暴露出来，默认忽略它们，
                // 看视频时不会把栏和灵动岛占成音乐。
                ConfigSwitch {
                    buttonIcon: "language"; text: Translation.tr("Ignore browser media")
                    checked: Config.options.media.ignoreBrowserPlayers
                    onCheckedChanged: { Config.options.media.ignoreBrowserPlayers = checked; }
                }
                ConfigSwitch {
