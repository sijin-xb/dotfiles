...
Scope {
    ...
    IpcHandler {
        ...
        function close(): void { root.openCentered(false) }
    }
                    ...
                    GroupedList {
                        ...
                        RippleButton {
                            ...
                            contentItem: RowLayout {
                                anchors { fill: parent; leftMargin: 12; rightMargin: 12 }
                                spacing: 12
                                MaterialSymbol { text: "apps"; iconSize: Appearance.font.pixelSize.larger; color: Appearance.colors.colOnLayer1 }
                                StyledText { Layout.fillWidth: true; text: Translation.tr("默认打开"); font.pixelSize: Appearance.font.pixelSize.normal; color: Appearance.colors.colOnLayer1 }
                                MaterialSymbol { text: "chevron_right"; iconSize: Appearance.font.pixelSize.normal; color: Appearance.colors.colOnLayer1; opacity: 0.4 }
                            }

                            Component {
                                id: defaultAppsSubmenu
                                DefaultAppsSubmenu {}
                            }
                            ...
                            HoverHandler {
                                onHoveredChanged: {
                                    if (hovered) {
                                        submenuCloseTimer.stop()
                                        menuWindow.submenuAnchorY = menuCard.y + defaultAppsRow.mapToItem(menuCard, 0, 0).y
                                        menuWindow.openSubmenuComponent = defaultAppsSubmenu
                                    } else {
                                        submenuCloseTimer.restart()
                                    }
                                }
