...
PanelWindow {
    ...
    // 选中窗口整块高亮填充：提高不透明度以清晰区分（原 0.85 过淡）
    property color windowFillColor: ColorUtils.transparentize(windowBorderColor, 0.55)
    ...
    MouseArea {
        ...
        Repeater {
            ...
            delegate: TargetRegion {
                ...
                // 选中窗口整块高亮：选中时完全不透明，未选中保持低不透明度
                opacity: root.draggedAway ? 0 : (targeted ? 1 : root.targetRegionOpacity)
