...
hl.config({
    decoration = {
        ...
        -- ============================================================
        -- 阴影代替边框：用柔和的深色光晕做"软边框"
        -- ------------------------------------------------------------
        -- 思路：关掉明显的硬边框 → 用大阴影 + 深色 + 偏移
        -- 营造窗口"浮"在玻璃上的层次感，边缘会自然形成
        -- 一圈暗调光晕，替代原来的实线边框
        -- ============================================================
        shadow = {
            -- 阴影扩散范围：越大光晕越柔和，
            -- 45-50 可以形成大约 10px 可见的"软边框"宽度
            range        = 48,
            -- 阴影偏移：向下+向右稍微偏一点，
            -- 模拟左上打光的立体感（3, 5）
            offset       = {3, 5},
            -- 边缘羽化：越高越柔和，
            -- 15-18 让阴影晕开非常自然，不会有硬边
            render_power = 17,
            -- 阴影颜色：这里是关键！
            -- 末尾两位 alpha 调深 → 0x3A~0x48，
            -- 形成一圈明显的深色光晕替代边框
            -- 000000 = 纯黑阴影，液态玻璃推荐纯黑偏深
            color        = "rgba(0000003F)",
        },
